...
*        DATA(lv_name) = lo_storex->get_name( ).
    ...
    endtry.
        ...
        try.
                ...
                if lt_tenant eq '100'.
                  x_sender = 'do.not.reply@my401475.mail.lab.s4hana.cloud.sap'.
                else.
                  x_sender = 'do.not.reply@my401594.mail.lab.s4hana.cloud.sap'.
                endif.

                x_email = lt_email.

                lo_mail->set_sender( 'do.not.reply@my401594.mail.lab.s4hana.cloud.sap' ).
